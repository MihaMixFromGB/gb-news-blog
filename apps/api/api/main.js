/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ './apps/api/src/app/app.module.ts': /***/ (
      ...
      const categories_module_1 = __webpack_require__(
        './apps/api/src/app/categories/categories.module.ts'
      );
      const comments_module_1 = __webpack_require__(
    ...
    /***/ './apps/api/src/app/app.service.ts': /***/ (
      ...
      AppService = tslib_1.__decorate([(0, common_1.Injectable)()], AppService);
    ...
    /***/ './apps/api/src/app/auth/auth.controller.ts': /***/ (
      ...
      const tslib_1 = __webpack_require__('tslib');
      const common_1 = __webpack_require__('@nestjs/common');
      const local_auth_guard_1 = __webpack_require__(
        ...
        validateUser(email, password) {
          return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (user && user.password === password) {
              ...
              const { password } = user,
                result = tslib_1.__rest(user, ['password']);
              return result;
            }
            return null;
          });
    ...
    /***/ './apps/api/src/app/auth/local-auth.guard.ts': /***/ (
      ...
      const common_1 = __webpack_require__('@nestjs/common');
      const passport_1 = __webpack_require__('@nestjs/passport');
      let LocalAuthGuard = class LocalAuthGuard extends (0,
    ...
    /***/ './apps/api/src/app/auth/local.strategy.ts': /***/ (
      ...
      let LocalStrategy = class LocalStrategy extends (0,
    ...
    /***/ './apps/api/src/app/categories/categories.controller.ts': /***/ (
      ...
      const tslib_1 = __webpack_require__('tslib');
      const common_1 = __webpack_require__('@nestjs/common');
      const categories_service_1 = __webpack_require__(
      ...
      tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            typeof (_d =
              typeof dto_1.CategoryDto !== 'undefined' && dto_1.CategoryDto) ===
            'function'
              ? _d
              : Object,
          ]),
      ...
      CategoriesController = tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            typeof (_a =
              typeof categories_service_1.CategoriesService !== 'undefined' &&
              categories_service_1.CategoriesService) === 'function'
              ? _a
              : Object,
          ]),
        ],
    ...
    /***/ './apps/api/src/app/categories/categories.module.ts': /***/ (
      ...
      const common_1 = __webpack_require__('@nestjs/common');
      const typeorm_1 = __webpack_require__('@nestjs/typeorm');
      const categories_controller_1 = __webpack_require__(
        './apps/api/src/app/categories/categories.controller.ts'
      );
      const categories_service_1 = __webpack_require__(
        './apps/api/src/app/categories/categories.service.ts'
      ...
      CategoriesModule = tslib_1.__decorate(
        [
          (0, common_1.Module)({
            imports: [
              typeorm_1.TypeOrmModule.forFeature([entities_1.CategoryEntity]),
            ],
    ...
    /***/ './apps/api/src/app/categories/categories.service.ts': /***/ (
      ...
      CategoriesService = tslib_1.__decorate(
        [
          ...
          tslib_1.__param(
            0,
            (0, typeorm_1.InjectRepository)(entities_1.CategoryEntity)
          ),
          tslib_1.__metadata('design:paramtypes', [
            typeof (_a =
    ...
    /***/ './apps/api/src/app/comments/comments.controller.ts': /***/ (
      ...
      const tslib_1 = __webpack_require__('tslib');
      const common_1 = __webpack_require__('@nestjs/common');
      const comments_service_1 = __webpack_require__(
      ...
      tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            typeof (_b =
              typeof dto_1.NewsIdDto !== 'undefined' && dto_1.NewsIdDto) ===
            'function'
              ? _b
              : Object,
          ]),
      ...
      tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            typeof (_e =
              typeof dto_1.CommentDto !== 'undefined' && dto_1.CommentDto) ===
            'function'
              ? _e
              : Object,
          ]),
      ...
      CommentsController = tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            typeof (_a =
              typeof comments_service_1.CommentsService !== 'undefined' &&
              comments_service_1.CommentsService) === 'function'
              ? _a
              : Object,
          ]),
        ],
    ...
    /***/ './apps/api/src/app/comments/comments.module.ts': /***/ (
      ...
      const common_1 = __webpack_require__('@nestjs/common');
      const typeorm_1 = __webpack_require__('@nestjs/typeorm');
      const comments_controller_1 = __webpack_require__(
        './apps/api/src/app/comments/comments.controller.ts'
      );
      const comments_service_1 = __webpack_require__(
        './apps/api/src/app/comments/comments.service.ts'
      ...
      const socket_comments_gateway_1 = __webpack_require__(
        ...
        [
          (0, common_1.Module)({
            ...
            providers: [
              ...
              socket_comments_gateway_1.SocketCommentsGateway,
            ],
          }),
        ],
        CommentsModule
    ...
    /***/ './apps/api/src/app/comments/comments.service.ts': /***/ (
      ...
      const convertToUserInfo_1 = __webpack_require__(
        './apps/api/src/app/utils/convertToUserInfo.ts'
      );
      const emitter_events_types_1 = __webpack_require__(
      ...
      let CommentsService = class CommentsService {
        ...
        findAllByNews(newsId) {
          return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const comments = [];
            const rootComments = (yield this.commentsRepository.findRoots({
              relations: ['user'],
            }))
            ...
            return comments.map((comment) => {
              comment.user = (0, convertToUserInfo_1.convertToUserInfo)(
                comment.user
              );
              return comment;
            });
        ...
        create(commentDto) {
          return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            newComment = Object.assign(
              Object.assign(Object.assign({}, newComment), commentDto),
              { user }
            );
            newComment = yield this.commentsRepository.save(newComment);
            newComment.user = (0, convertToUserInfo_1.convertToUserInfo)(
              newComment.user
            );
            this.eventEmitter.emit(
              'comment.create',
              new emitter_events_types_1.EmitterEventDto(
                'comment-create',
                newComment.newsId.toString(),
                {
        ...
        update(id, commentDto) {
          return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            updatedComment = Object.assign(
              Object.assign(Object.assign({}, updatedComment), commentDto),
              { user }
            );
            updatedComment = yield this.commentsRepository.save(updatedComment);
            updatedComment.user = (0, convertToUserInfo_1.convertToUserInfo)(
              updatedComment.user
            );
            this.eventEmitter.emit(
              'comment.edited',
              new emitter_events_types_1.EmitterEventDto(
                'comment-edited',
                updatedComment.newsId.toString(),
                {
        ...
        remove(id) {
          return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            deletedComment = yield this.commentsRepository.remove(
              deletedComment
            );
            deletedComment.user = (0, convertToUserInfo_1.convertToUserInfo)(
              deletedComment.user
            );
            this.eventEmitter.emit(
              'comment.deleted',
              new emitter_events_types_1.EmitterEventDto(
                'comment-deleted',
                deletedComment.newsId.toString(),
                {
        ...
        removeAllByNews(newsId) {
          return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            commentsByNews = yield this.commentsRepository.remove(
              commentsByNews
            );
        ...
        convertTreeToArray(parent, arr) {
          return tslib_1.__awaiter(this, void 0, void 0, function* () {
            arr = arr || [];
            // eslint-disable-next-line @typescript-eslint/no-unused-vars
            const { children: _children } = parent,
              _parent = tslib_1.__rest(parent, ['children']);
            arr.push(_parent);
            const commentsTree =
              yield this.commentsRepository.findDescendantsTree(parent, {
                depth: 1,
                relations: ['user'],
              });
      ...
      CommentsService = tslib_1.__decorate(
        [
          ...
          tslib_1.__param(
            0,
            (0, typeorm_1.InjectRepository)(entities_1.CommentEntity)
          ),
          tslib_1.__metadata('design:paramtypes', [
            typeof (_a =
              typeof typeorm_2.TreeRepository !== 'undefined' &&
              typeorm_2.TreeRepository) === 'function'
              ? _a
              : Object,
            typeof (_b =
              typeof users_service_1.UsersService !== 'undefined' &&
    ...
    /***/ './apps/api/src/app/comments/socket-comments.gateway.ts': /***/ (
      ...
      tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata(
            'design:type',
            typeof (_a =
              typeof socket_io_1.Server !== 'undefined' &&
              socket_io_1.Server) === 'function'
              ? _a
              : Object
          ),
        ],
        SocketCommentsGateway.prototype,
        'server',
        void 0
      );
      tslib_1.__decorate(
      ...
      tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            typeof (_d =
              typeof emitter_events_types_1.EmitterEvent !== 'undefined' &&
              emitter_events_types_1.EmitterEvent) === 'function'
              ? _d
              : Object,
          ]),
          tslib_1.__metadata('design:returntype', void 0),
    ...
    /***/ './apps/api/src/app/news/news.controller.ts': /***/ (
      ...
      tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            typeof (_d =
              typeof dto_1.NewsDto !== 'undefined' && dto_1.NewsDto) ===
            'function'
              ? _d
              : Object,
          ]),
    ...
    /***/ './apps/api/src/app/news/news.service.ts': /***/ (
      ...
      let NewsService = class NewsService {
        ...
        create(newsDto) {
          return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const category = yield this.categoriesService.findById(
              newsDto.categoryId
            );
            if (!category) {
              return null;
            ...
            newNews = Object.assign(
              Object.assign(Object.assign({}, newNews), newsDto),
              { author, category }
            );
            newNews = yield this.newsRepository.save(newNews);
            newNews.author = (0, convertToUserInfo_1.convertToUserInfo)(
              newNews.author
            );
            return newNews;
          });
        ...
        update(id, newsDto) {
          return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            updatedNews = Object.assign(
              Object.assign(Object.assign({}, updatedNews), newsDto),
              { author, category }
            );
            updatedNews = yield this.newsRepository.save(updatedNews);
            updatedNews.author = (0, convertToUserInfo_1.convertToUserInfo)(
              updatedNews.author
            );
            return updatedNews;
          });
        ...
        remove(id) {
          return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            deletedNews.author = (0, convertToUserInfo_1.convertToUserInfo)(
              deletedNews.author
            );
            return deletedNews;
          });
      ...
      NewsService = tslib_1.__decorate(
        [
          ...
          tslib_1.__param(
            0,
            (0, typeorm_1.InjectRepository)(entities_1.NewsEntity)
          ),
          tslib_1.__metadata('design:paramtypes', [
            typeof (_a =
              typeof typeorm_2.Repository !== 'undefined' &&
    ...
    /***/ './apps/api/src/app/users/users.controller.ts': /***/ (
      ...
      tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            typeof (_d =
              typeof dto_1.CreateUserDto !== 'undefined' &&
              dto_1.CreateUserDto) === 'function'
              ? _d
              : Object,
          ]),
          tslib_1.__metadata(
      ...
      tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            Number,
            typeof (_f =
              typeof dto_1.UpdateUserDto !== 'undefined' &&
              dto_1.UpdateUserDto) === 'function'
              ? _f
              : Object,
          ]),
          tslib_1.__metadata(
    ...
    /***/ './apps/api/src/app/users/users.service.ts': /***/ (
        ...
        create(userDto) {
          return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            newUser = Object.assign(
              Object.assign(Object.assign({}, newUser), userDto),
              { role: 'user' }
            );
      ...
      UsersService = tslib_1.__decorate(
        [
          ...
          tslib_1.__param(
            0,
            (0, typeorm_1.InjectRepository)(entities_1.UserEntity)
          ),
          tslib_1.__metadata('design:paramtypes', [
            typeof (_a =
              typeof typeorm_2.Repository !== 'undefined' &&
    ...
    /***/ './libs/dto/src/index.ts': /***/ (
      ...
      tslib_1.__exportStar(
        __webpack_require__('./libs/dto/src/lib/user/create-user.dto.ts'),
        exports
      );
      tslib_1.__exportStar(
        __webpack_require__('./libs/dto/src/lib/user/update-user.dto.ts'),
        exports
      );
      tslib_1.__exportStar(
        __webpack_require__('./libs/dto/src/lib/news/news.dto.ts'),
        exports
      );
      tslib_1.__exportStar(
        __webpack_require__('./libs/dto/src/lib/category/category.dto.ts'),
        exports
      );
      tslib_1.__exportStar(
        __webpack_require__('./libs/dto/src/lib/comment/comment.dto.ts'),
        exports
      );
      tslib_1.__exportStar(
        __webpack_require__('./libs/dto/src/lib/comment/news-id.dto.ts'),
        exports
      );
    ...
    /***/ './libs/entities/src/index.ts': /***/ (
      ...
      const tslib_1 = __webpack_require__('tslib');
      tslib_1.__exportStar(
        __webpack_require__('./libs/entities/src/lib/user.entity.ts'),
        exports
      );
      tslib_1.__exportStar(
        __webpack_require__('./libs/entities/src/lib/news.entity.ts'),
        exports
      );
      tslib_1.__exportStar(
        __webpack_require__('./libs/entities/src/lib/category.entity.ts'),
        exports
      );
      tslib_1.__exportStar(
        __webpack_require__('./libs/entities/src/lib/comment.entity.ts'),
        exports
      );
    ...
    /***/ './libs/entities/src/lib/comment.entity.ts': /***/ (
      ...
      const tslib_1 = __webpack_require__('tslib');
      const typeorm_1 = __webpack_require__('typeorm');
      const interfaces_1 = __webpack_require__(
        './libs/interfaces/src/index.ts'
      );
      const user_entity_1 = __webpack_require__(
      ...
      tslib_1.__decorate(
        [(0, typeorm_1.Column)(), tslib_1.__metadata('design:type', Number)],
        CommentEntity.prototype,
        'newsId',
        void 0
      );
      tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata(
            'design:type',
            typeof (_a =
              typeof interfaces_1.UserInfo !== 'undefined' &&
              interfaces_1.UserInfo) === 'function'
              ? _a
              : Object
          ),
        ],
    ...
    /***/ './libs/entities/src/lib/news.entity.ts': /***/ (
      ...
      const category_entity_1 = __webpack_require__(
        './libs/entities/src/lib/category.entity.ts'
      );
      ...
      tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata(
            'design:type',
            typeof (_a =
              typeof category_entity_1.CategoryEntity !== 'undefined' &&
              category_entity_1.CategoryEntity) === 'function'
              ? _a
              : Object
          ),
        ],
    ...
    /***/ './libs/interfaces/src/index.ts': /***/ (
      ...
      const tslib_1 = __webpack_require__('tslib');
      tslib_1.__exportStar(
        __webpack_require__('./libs/interfaces/src/lib/user.interface.ts'),
        exports
      );
      tslib_1.__exportStar(
        __webpack_require__('./libs/interfaces/src/lib/user-info.interface.ts'),
        exports
      );
      tslib_1.__exportStar(
        __webpack_require__('./libs/interfaces/src/lib/news.interface.ts'),
        exports
      );
      tslib_1.__exportStar(
        __webpack_require__('./libs/interfaces/src/lib/category.interface.ts'),
        exports
      );
      tslib_1.__exportStar(
        __webpack_require__('./libs/interfaces/src/lib/comment.interface.ts'),
        exports
      );
