...
let AuthController = class AuthController {
    ...
    login(req, res) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            res.setHeader('Set-Cookie', `token=${access_token}; Max-Age=${parseInt(process.env.JWT_EXPIRESIN_SEC)}; Path=/; SameSite=None; Secure`);
            return req.user;
        });
    }
};
...
function bootstrap() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        let pathToAssets = (0, path_1.join)(__dirname, 'assets');
        // For Serverless function on Vercel hosting (/api/main.js)'
        if (!(0, fs_1.existsSync)(pathToAssets)) {
            pathToAssets = (0, path_1.join)(__dirname, '..', 'assets');
        }
